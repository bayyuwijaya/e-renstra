    ...
    <div class="col-md-12">
        <div class="portlet light" style="position:relative">
            ...
            <div class="portlet-body form" id="page-content" style="display:block">
                <?=form_open_multipart('administrator/data_renstra/file_support/tambah_data_proses', array("id"=>"file_support", "method"=>"post", "class"=>"horizontal-form") );?>
                    <div class="form-body">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group" id="form_nm_file">
                                      ...
                                      <input required type="text" id="nm_file" name="nm_file" class="form-control" placeholder="Ketik Nama File disini">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group" id="form_keterangan">
                                      ...
                                      <textarea required id="keterangan" name="keterangan" class="form-control" placeholder="Ketik Keterangan disini"> </textarea>
