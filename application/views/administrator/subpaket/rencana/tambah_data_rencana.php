                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <div class="form-group" id="form_sub_komponen">
                                            ...
                                            <input required type="text" id="sub_komponen" name="sub_komponen" class="form-control" placeholder="Ketik Sub Komponen disini">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group" id="form_output_satuan">
                                            <label for="output_satuan" class="control-label">Satuan Output <span class="required">* </span></label>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group" id="form_output_target">
                                          <label for="output_target" class="control-label">Target Output <span class="required">* </span></label>
                                          <input required type="text" id="output_target" name="output_target" class="form-control" placeholder="Ketik Output Target disini">
                                          <span class="required" style="color:red"><i> (Koma wajib diganti dengan titik) </i></span>
                                    ...
                                    <div class="row">                                      
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group" id="form_outcome_satuan">
                                          <label for="outcome_satuan" class="control-label">Satuan Outcome <span class="required">* </span></label>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group" id="form_outcome_target">
                                            <label for="outcome_target" class="control-label">Target Outcome <span class="required">* </span></label>
                                            <input required type="text" id="outcome_target" name="outcome_target" class="form-control" placeholder="Ketik Outcome Target disini">
                                            <span class="required" style="color:red"><i> (Koma wajib diganti dengan titik) </i></span>
                                    ...
                                    <div class="row">   
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group" id="form_anggaran">
                                          ...
                                          <input required type="text" id="anggaran" name="anggaran" class="form-control" placeholder="Ketik Anggaran disini">
                                          <br>
                                          <input type="hidden" id="input_anggaran" name="input_anggaran" value="" >
