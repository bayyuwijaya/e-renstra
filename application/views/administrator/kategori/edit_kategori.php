    ...
    <div class="col-md-12">
        <div class="portlet light" style="position:relative">
            ...
            <div class="portlet-body form" id="page-content" style="display:block">
                <form action="<?=site_url('administrator/'.$controller_dir.$controller.'/proses_edit_kategori'.'/'.$kategori->id_kategori)?>" method="post" id="<?=$controller?>" enctype="multipart/form-data" class="horizontal-form">
                    <div class="form-body">
                      <input value="<?=$kategori->id_kategori?>" type="hidden" name="id_kategori">                        
                                  ...
                                  <div class="row">
                                      <div class="col-md-12">
                                          <div class="form-group" id="form_nm_kegiatan">
                                              <label for="kategori" class="control-label">Nama Kategori <span class="required">* </span></label>
                                              <input required type="text" id="nm_kategori" name="nm_kategori" class="form-control" placeholder="Ketik Kategori disini" value="<?=$kategori->nm_kategori?>">
