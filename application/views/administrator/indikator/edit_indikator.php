    ...
    <div class="col-md-12">
        <div class="portlet light" style="position:relative">
            ...
            <div class="portlet-body form" id="page-content" style="display:block">
                <form action="<?=site_url('administrator/'.$controller_dir.$controller.'/proses_edit_indikator'.'/'.$indikator->id_indikator)?>" method="post" id="<?=$controller?>" enctype="multipart/form-data" class="horizontal-form">
                    <div class="form-body">
                    <input value="<?=$indikator->id_indikator?>" type="hidden" name="id_indikator">                         
                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group" id="form_nm_indikator">
                                              ...
                                              <input required type="text" id="nm_indikator" name="nm_indikator" class="form-control" placeholder="Ketik Nama Indikator disini" value="<?=$indikator->nm_indikator?>">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group" id="form_bobot">
                                              ...
                                              <input required type="text" id="bobot" name="bobot" class="form-control" placeholder="Ketik Nilai Bobot disini" value="<?=$indikator->bobot?>">
