    ...
    <div class="col-md-12">
        <div class="portlet light" style="position:relative;">
            ...
            <div class="portlet-body form" id="page-content" style="display:none">
                <form action="<?=site_url('administrator/setting/atur_hakakses/process_add_prefillage')?>" method="post" id="<?=$controller?>" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
    ...
    $(document).ready( function () {
        $('#<?=$controller?>').submit(function(){
            swal({
              ...
              text: "Anda yakin akan Menambahkan Hak Akses Ini?",
              type: "warning",
            ...
            function() {
              $.ajax({
                url:"<?=site_url('administrator/setting/atur_hakakses/process_add_prefillage')?>",
                type:"POST",
