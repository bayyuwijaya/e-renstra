    ...
    <div class="col-md-12">
        <div class="portlet light" style="position:relative">
            ...
            <div class="portlet-body form" id="page-content" style="display:nonee">
                <form action="<?=site_url('administrator/'.$controller_dir.$controller.'/proses_edit_satuan')?>" method="post" id="<?=$controller?>" enctype="multipart/form-data" class="horizontal-form">
                    <div class="form-body">                        
                          ...
                          <ul class="nav nav-tabs">
                              <li class="active">
                                  <a href="#satuan" data-toggle="tab" aria-expanded="true">
                                   Satuan </a>
                                   <input type="hidden" id="id_satuan" name="id_satuan" value="<?=$satuan->id_satuan?>" />
                              </li>                              
                          </ul>
                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group" id="form_nm_satuan">
                                              ...
                                              <input required type="text" id="nm_satuan" name="nm_satuan" class="form-control" placeholder="Ketik Nama Satuan disini" value="<?=$satuan->nm_satuan?>" />
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group" id="form_jns_satuan">
                                              ...
                                              <input required type="text" id="jns_satuan" name="jns_satuan" class="form-control" placeholder="Ketik Jenis Satuan disini" value="<?=$satuan->jns_satuan?>" />
