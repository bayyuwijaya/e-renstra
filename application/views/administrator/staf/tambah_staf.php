                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group" id="form_nidn">
                                              ...
                                              <input required type="text" id="nidn" name="nidn" class="form-control" placeholder="Ketik Nomor Induk Pegawai disini">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group" id="form_nm_sdm">
                                              ...
                                              <input required type="text" id="nm_sdm" name="nm_sdm" class="form-control" placeholder="Ketik Nama Staf disini">
