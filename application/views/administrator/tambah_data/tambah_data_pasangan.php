                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="biodata">
                                        ...
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <div class="form-group" id="form_jk">
                                                <label for="jk" class="control-label">Status Pernikahan <span class="required">* </span></label>
                                                <select style="width:100%" required id="jk" name="status_pernikahan" class="form-control">
                                                    <option value=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_nipd">
                                                <label for="nipd" class="control-label">No Akta<span class="required">* </span></label>
                                                <input required type="text" id="nipd" name="no_akta" class="form-control" placeholder="No Akta">
                                                <span id="error_nipd" class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
