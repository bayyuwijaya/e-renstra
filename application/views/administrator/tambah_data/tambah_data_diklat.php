                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group" id="form_jenis">
                                                ...
                                                <input required type="text" id="jenis" name="jenis_diklat" class="form-control" placeholder="Jenis Diklat">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_nipd">
                                                ...
                                                <input required type="text" id="nama" name="tmpt_diklat" class="form-control" placeholder="Tempat Diklat">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_tgl_lahir">
                                                ...
                                                <div class="input-group date" id="datepicker_pd">
                                                    ...
                                                    <input required type="text" id="tgl_lahir" name="tgl_mulai" class="form-control" placeholder="Tanggal Mulai" readonly>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_tgl_lahir">
                                                ...
                                                <div class="input-group date" id="datepicker_pd1">
                                                    <span class="input-group-btn">
                                                        <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                                    </span>
                                                    <input required type="text" id="tgl_selesai" name="tgl_selesai" class="form-control" placeholder="Tanggal Selesai" readonly>
                                                </div>
                                                <span id="error_tgl_lahir" class="help-block"></span>
                                            </div>
                                        </div>
