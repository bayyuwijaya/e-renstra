                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="jenjang" name="tahun" class="form-control" placeholder="2019">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="tgl_awal" name="tgl_awal_cuti" class="form-control" placeholder="Tanggal Awal Cuti">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="tgl_akhir" name="tgl_akhir_cuti" class="form-control" placeholder="Tanggal Akhir Cuti">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="cuti_sakit" class="form-control" placeholder="Total Cuti">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="cuti_alasan_penting" class="form-control" placeholder="Total Cuti">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="cuti_tahunan" class="form-control" placeholder="Total Cuti">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="cuti_besar" class="form-control" placeholder="Total Cuti">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>                        
                        </div>
