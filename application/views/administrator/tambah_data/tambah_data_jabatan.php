                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_jenis">
                                                ...
                                                <input type="text" id="tmt" name="tmt_kerja" class="form-control" placeholder="input TMT Kerja">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_nipd">
                                                ...
                                                <input type="text" id="no_sk" name="no_sk" class="form-control" placeholder="Input No. SK">
                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group" id="form_nipd">
                                                ...
                                                <input required type="text" id="jabatan" name="jabatan" class="form-control" placeholder="Jabatan saat ini">
                                                <span id="error_jabatan" class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_nipd">
                                                <label for="jenjang" class="control-label">PPK<span class=""></span></label>
                                                <input  type="text" id="nama" name="ppk" class="form-control" placeholder="PPK">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_nipd">
                                                <label for="jenjang" class="control-label">SATKER<span class=""></span></label>
                                                <input  type="text" id="nama" name="satker" class="form-control" placeholder="SATKER">
                                                <span id="error_nipd" class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_nipd">
                                                ...
                                                <input required type="text" id="nama" name="kasi" class="form-control" placeholder="KASI / SUBAG">
                                                <span id="error_nipd" class="help-block"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                           <div class="form-group" id="form_nipd">
                                               ...
                                               <input type="text" id="tmt" name="tgl_msk" class="form-control" placeholder="Input Tanggal Masuk">
                                               <span id="error_tmt" class="help-block"></span>
                                           </div>
                                       </div>
                                       <div class="col-md-6">
                                           <div class="form-group" id="form_nipd">
                                               ...
                                               <input type="text" id="tmt" name="tgl_keluar" class="form-control" placeholder="Input Tanggal Keluar">
                                               <span id="error_tmt" class="help-block"></span>
                                           </div>
                                       </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group" id="form_nipd">
                                                ...
                                                <input required type="text" id="nama" name="loka" class="form-control" placeholder="LOKA / BALAI / BALAI BESAR">
                                                <span id="error_nipd" class="help-block"></span>
                                            </div>
                                        </div>
