                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group" id="form_nm_paket">
                                                ...
                                                <input required type="text" id="nm_paket" name="nm_paket" class="form-control" placeholder="Paket Pekerjaan">
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-md-4">
                                            <div class="form-group" id="form_kode">
                                                ...
                                                <input required type="text" id="kode" name="kode" class="form-control" placeholder="Kode Paket">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_cost_kegiatan">
                                                ...
                                                <input required type="text" name="cost_kegiatan" id="cost_kegiatan" class="form-control" placeholder="Anggaran Kegiatan">
                                                <br>
                                                <input type="hidden" id="anggaran_kegiatan" name="anggaran_kegiatan" value="" >
