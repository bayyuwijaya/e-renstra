        ...
        <div class="portlet light" style="position:relative">
            <div class="portlet-title">
                ...
                <div class="actions" id="tombol-action" style="display:block; margin-left:5px;">
                    <a class="btn blue btn-sm" href="<?=site_url('administrator/mhs_dir/data_anak/print_excel/'.$mahasiswa->id_sdm)?>">
                    ...
                    <table id="<?=$controller?>_table" class="table table-bordered table-striped table-hover" style="width:100%">
                        ...
                        <tbody>                            
                          <?php 
                            ...
                            foreach ($this->Content_m->select_db('sispeg_tr_pegawai_anak')->result() as $key ) { ?>
                            <tr>
                              <td><?=$key->nama?></td>
                              ...
                              <td><?=$key->status?></td>
                              <td>
                                <a href="<?=site_url()?>/administrator/mhs_dir/data_anak/edit_data/<?=$mahasiswa->id_sdm?>/<?=$key->id_sdm_anak?>">
                                  <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                </a>
                                <a data-toggle="tooltip" data-placement="top" title="Hapus" href="<?=site_url()?>/administrator/mhs_dir/data_anak/del_data/<?=$key->id_sdm_anak?>" onclick="return confirm('Are you sure?')" style="cursor:pointer">
