                ...
                <div class="table-responsive">
                    <table id="<?=$controller?>_table" class="table table-bordered table-striped table-hover" style="width:100%">
                        ...
                        <?php 
                          ...
                          foreach ($this->Content_m->select_db('sispeg_tr_pegawai_pasangan')->result() as $key ) { ?>
                            <tr>
                              <td><?=$key->nama?></td>
                              ...
                              <td>
                                <a href="<?=site_url()?>/administrator/mhs_dir/data_pasangan/edit_data/<?=$mahasiswa->id_sdm?>/<?=$key->id_sdm_pasangan?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                <a data-toggle="tooltip" data-placement="top" title="Hapus" href="<?=site_url()?>/administrator/mhs_dir/data_pasangan/del_data/<?=$key->id_sdm_pasangan?>" onclick="return confirm('Are you sure?')" style="cursor:pointer">
