    ...
    <div class="col-md-12">
        <div class="portlet light" style="position:relative">
            ...
            <div class="portlet-body" id="page-content">
                ...
                <?= form_open('administrator/pengaturan/atur_hakakses/edit_administrator', array('class'=>"form-horizontal")) ?>

                  <input type="hidden" name="id_reg_pd" value="<?=$row->id_reg_pd?>">
                  <input type="hidden" name="nm_pd" value="<?php echo isset($row->nm_pd)? $row->nm_pd : ''?>">
                  <div class="form-group">
                      <label class="col-sm-3 col-md-2 control-label">Nama</label>
                      <div class="col-sm-9 col-md-7">
                          <input name="nm_sdm" value="<?php echo isset($row->nm_pd)? $row->nm_pd : ''?>" type="text"  class="form-control" disabled>
                      </div>
                  ...
                  <br><hr><br>          
                  <?php $username = $this->Content_m->get_row_custom('global_user','id_user',$row->id_reg_pd)->username?>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9 col-md-offset-2 col-md-10">
                      ...
                      <?= anchor('admin/daftar_online', 'Batal', array('class'=>'btn btn-default')) ?>
                    </div>
                  </div>
                  <br><br>
                <?= form_close() ?>
