            ...
            <div class="portlet-body form" id="page-content" style="display:none">
                <form action="<?=site_url('administrator/'.$controller_dir.$controller.'/edit_data_proses')?>" method="post" id="<?=$controller?>" enctype="multipart/form-data" class="horizontal-form">
                    <div class="form-body">
                        ...
                        <input value="<?=$pegawai_pt->id_sdm_pt?>" type="hidden" name="id_sdm_pt">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="jenjang" name="jenjang" class="form-control" placeholder="Jenjang" value="<?=$pegawai_pt->jenjang?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="jurusan" class="form-control" placeholder="Jurusan"  value="<?=$pegawai_pt->jurusan?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="institusi" class="form-control" placeholder="Sekolah/Universitas"  value="<?=$pegawai_pt->institusi?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="thn_lulus" class="form-control" placeholder="Tahun Lulus"  value="<?=$pegawai_pt->thn_lulus?>" >
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="no_ijasah" class="form-control" placeholder="Tahun Lulus"  value="<?=$pegawai_pt->no_ijasah?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                        </div>
