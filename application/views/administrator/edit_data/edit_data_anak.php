               ...
               <form action="<?=site_url('administrator/'.$controller_dir.$controller.'/edit_data_proses')?>" method="post" id="<?=$controller?>" enctype="multipart/form-data" class="horizontal-form">
                    <div class="form-body">
                        ...
                        <div class="tabbable-custom ">
                            ...
                            <input value="<?=$anak->id_sdm_anak?>" type="hidden" name="id_sdm_anak">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_nipd">
                                                ...
                                                <input required type="text" id="nama" name="nama" class="form-control" placeholder="Nama Lengkap" value="<?=$anak->nama?>">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group" id="form_jk">
                                                ...
                                                <select style="width:100%" required id="jk" name="status" class="form-control">
                                                    <option value=""></option>
                                                    <option value="Anak Kandung" <?=$anak->status == 'Anak Kandung'?'selected':''?> >Anak Kandung</option>
                                                    <option value="Anak Angkat" <?=$anak->status == 'Anak Angkat'?'selected':''?>>Anak Angkat</option>
                                                    <option value="Lainnya" <?=$anak->status == 'Lainnya'?'selected':''?>>Lainnya</option>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_tmpt_lahir">
                                                ...
                                                <input required type="text" id="tmpt_lahir" name="tmpt_lahir" class="form-control" placeholder="Tempat Lahir" value="<?=$anak->tmpt_lahir?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="form_tgl_lahir">
                                                ...
                                                <div class="input-group date" id="datepicker_pd">
                                                    ...
                                                    <input required type="text" id="tgl_lahir" name="tgl_lahir" class="form-control" placeholder="Tanggal Lahir" value="<?=$anak->tgl_lahir?>" readonly>
                                                </div>
