        ...
        <div class="portlet light" style="position:relative">
            ...
            <div class="portlet-body form" id="page-content" style="display:none">
                <form action="<?=site_url('administrator/'.$controller_dir.$controller.'/edit_data_proses')?>" method="post" id="<?=$controller?>" enctype="multipart/form-data" class="horizontal-form">
                    <div class="form-body">
                        <input value="<?=$evaluasi->id_sdm?>" type="hidden" name="id_sdm">
                        <input value="<?=$evaluasi->id_evaluasi?>" type="hidden" name="id_evaluasi">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="periode_penilaian" class="form-control" placeholder="TRIWULAN III" value="<?=$evaluasi->periode_penilaian?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="jenjang" name="jabatan" class="form-control" placeholder="Pengadministrasi Umum" value="<?=$evaluasi->jabatan?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="kelas_jabatan" class="form-control" placeholder="5" value="<?=$evaluasi->kelas_jabatan?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="datepicker_pd" name="tgl_mulai_kerja" class="form-control" placeholder="2 Januari 2019" value="<?=$evaluasi->tgl_mulai_kerja?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="jenjang" name="pemahaman_terhadap_pekerjaan" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->pemahaman_terhadap_pekerjaan?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="ketepatan_waktu_dalam_menyelesaikan_tugas" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->ketepatan_waktu_dalam_menyelesaikan_tugas?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="kesesuaian_hasil_kerja_dengan_yang_diharapkan" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->kesesuaian_hasil_kerja_dengan_yang_diharapkan?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="kerapian_pengadministrasian_pekerjaan" name="kerapian_pengadministrasian_pekerjaan" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->kerapian_pengadministrasian_pekerjaan?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="inisiatif" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->inisiatif?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="kerjasama" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->kerjasama?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="kesopanan_dan_keluwesan_komunikasi" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->kesopanan_dan_keluwesan_komunikasi?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="ketanggapan_dan_ketangkasan_dalam_melayani" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->ketanggapan_dan_ketangkasan_dalam_melayani?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="prilaku" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->prilaku?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="kedisiplinan" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->kedisiplinan?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="tanggung_jawab" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->tanggung_jawab?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="loyalitas" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->loyalitas?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="form_nipd">
                                    ...
                                    <input required type="text" id="nipd" name="ketaatan_terhadap_instruksi_kerja_atasan" class="form-control" placeholder="Beri Nilai 1-4" value="<?=$evaluasi->ketaatan_terhadap_instruksi_kerja_atasan?>">
                                    <span id="error_nipd" class="help-block"></span>
                                </div>
                            </div>   
