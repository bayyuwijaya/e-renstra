    ...
    <div class="col-md-12">
        <div class="portlet light" style="position:relative">
            ...
            <div class="portlet-body form" id="page-content" style="display:block">
                <form action="<?=site_url('administrator/'.$controller_dir.$controller.'/proses_edit_nmkegiatan')?>" method="post" id="<?=$controller?>" enctype="multipart/form-data" class="horizontal-form">
                    <div class="form-body">                        
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group" id="form_nm_kegiatan">
                                              ...
                                              <input type="hidden" name="id_nmkegiatan" id="id_nmkegiatan" value="<?=$nmkegiatan->id_nmkegiatan?>" />
                                              <input required type="text" id="nm_kegiatan" name="nm_kegiatan" class="form-control" placeholder="Ketik Nama Kegiatan disini" value="<?=$nmkegiatan->nm_kegiatan?>" />
...
<script>
    $(document).ready( function () {
        ...
        $("#id_kategori").val("<?=$nmkegiatan->id_kategori?>").trigger('change');
